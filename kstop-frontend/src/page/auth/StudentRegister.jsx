...
export default function StudentRegister() {
  ...
  // ── Step 2: submit form + OTP to register ─────────────────
        ...
        {step === 1 && (
          <form onSubmit={handleSendOtp} noValidate style={styles.form}>
            <div style={styles.row}>
              <Field label="Full name" name="name" type="text" placeholder="Soumya Das"
                value={form.name} onChange={handleChange} error={errors.name} />
              <Field label="Roll number" name="rollNumber" type="text" placeholder="22053XXX"
                value={form.rollNumber} onChange={handleChange} error={errors.rollNumber} />
            </div>

            <Field label="College email" name="email" type="email" placeholder="22053xxx@kiit.ac.in"
              value={form.email} onChange={handleChange} error={errors.email}
              hint="Must be your @kiit.ac.in address" />

            <div style={styles.row}>
              <SelectField label="Hostel" name="hostel" value={form.hostel}
                onChange={handleChange} options={HOSTELS} error={errors.hostel} />
  ...
  return (
    <div style={fieldStyles.wrap}>
      ...
      <div style={fieldStyles.passWrap}>
        <input id={name} name={name} type={show ? "text" : "password"} placeholder={placeholder} value={value} onChange={onChange}
...
/* ── Styles — identical to original + banner additions ── */
